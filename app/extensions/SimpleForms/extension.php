    ...
    function simpleForm($name="")
    {
        ...
        if ('POST' == $this->app['request']->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                $file = $_FILES["attach"]["tmp_name"]; //"attach" es el nombre del input, "tmp_name" coge el path temporal del fichero que se sube.
                $filename = $_FILES["attach"]["name"]; //"name" coge el nombre del fichero que se sube.
